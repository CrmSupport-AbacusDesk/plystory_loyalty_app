...
long:any;
    ...
    share() {
        let image = "";
        let app_url = "https://play.google.com/store/apps/details?id=com.plystory.app";
        this.socialSharing.share("Hey there join me (" + this.karigar_detail.full_name + "-" + this.karigar_detail.mobile_no + ") on Ply Story app. Enter my code *" + this.karigar_detail.referral_code + "* to earn points back in your wallet!", "", image, app_url)
            .then(resp => {
